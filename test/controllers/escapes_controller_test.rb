...
class EscapesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create escape" do
    assert_difference("Escape.count") do
      post escapes_url, params: { escape: { description: @escape.description, name: @escape.name, video_url: @escape.video_url } }
    end
  ...
  test "should update escape" do
    patch escape_url(@escape), params: { escape: { description: @escape.description, name: @escape.name, video_url: @escape.video_url } }
